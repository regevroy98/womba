...
class FullWorkflowOrchestrator:
    ...
    def _create_feature_branch(self, repo_path: Path):
        """Step 3: Create feature branch"""
        # Extract feature name from story title (simplified)
        feature_name = self.story_data.title.lower()
...
"""
    ...
    def _get_summary(self) -> dict:
        ...
        return {
            ...
            "story_title": self.story_data.title if self.story_data else None,
